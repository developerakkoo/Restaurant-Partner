...
export class AuthService {
  ...
  getPartnerById() {
    return this.http.get(
      environment.URL + `partner/get-current-user/${this.userId.value}`,
      {
        headers: {
  ...
  updatePartnerById(body: {}) {
    return this.http.put(
      environment.URL + `partner/update-profile/${this.userId.value}`,
      body,
      {
        headers: {
          'x-access-token': this.accessToken.value,
  ...
  getAllOrders(status: any) {
    return this.http.get(
      environment.URL + `order/get-by/shopId/${this.shopId.value}`,
      {
        headers: {
          'x-access-token': this.accessToken.value,
        },
